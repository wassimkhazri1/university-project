    ...
    >
      ...
      <div className="card-back">
        <div className="card-details">
          ...
          <p>
            <strong>Postes:</strong> {job.jobPositions}
          </p>
          <p>
            <strong>Description:</strong> {job.description}
          </p>
          <p>
            <strong>Date début:</strong> {job.startDate}
          </p>
          <p>
            <strong>Date expiration:</strong> {job.expiryDate}
          </p>
          <p>
            <strong>Formations:</strong> {job.formations}
          </p>
        </div>
