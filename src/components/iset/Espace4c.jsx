...
function Espace4c() {
  return (
    <div className="container mt-4 text-start">
        ...
        */}
<p>
  <img style={{display:" block; margin-left: auto; margin-right: auto"}} src="https://isetj.rnu.tn/images/ISET/articles/4c.png"  alt="" width="595" height="842" loading="lazy" data-path="local-images:/ISET/articles/4c.png" />
  </p>
<p>
