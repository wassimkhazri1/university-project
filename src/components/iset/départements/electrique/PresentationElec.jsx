  ...
  return (
    <div className="hero text-start">
      ...
      <p>
        ...
        réalité industrielle. Son objectif est de former des cadres qualifiés en
        génie électrique. Ainsi le département est muni d’un équipement de
      ...
      <p>
        ...
        <li>
          industries manufacturières et agro-alimentaires, secteurs de la santé,
          de l'audiovisuel et de télécommunications.
        </li>
      </p>
      ...
      <p>
        ...
        d’initiation et l’autre de perfectionnement, respectivement aux niveaux
        de L1 et L2. Les études se font sous forme de cours, des TD et TP. Les
        TP présentent plus que 50% du volume horaire global, ils sont présentés
        sous forme d’ateliers dans les laboratoires du département.
      </p>
