...
const Header = () => {
  ...
  const [content, setContent] = useState('');
     ...
     const user = JSON.parse(localStorage.getItem("user"));
      ...
      const isStudent = roles.roles?.includes("ROLE_STUDENT"); // Vérifie si ROLE_ADMIN est présent
      console.log(role);
...
const handleOpenAddModal1 = () => {
  ...
  return (
    <header className="bg-light">
      {/* Barre supérieure avec logo et titre */}
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="mainNav">
            <ul className="navbar-nav me-auto">
              ...
              */}
              {/* Vos menus déroulants existants... */}
             {/* <li className="nav-item dropdown">
                <a className="nav-link dropdown-toggle" href="#" id="departementsDropdown">
                  Départements
                </a> */}
                {/* [Votre mega-menu existant...] */}
            {/*  </li> */ }
    ...
    {/*   {role === "ROLE_ADMIN" && <AdminHeader />} */}
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="institueDropdown">
                ...
                <li><a href="/iset/regle" className="dropdown-item">règlement interne</a></li>
              ...
              <li><a href="/offre" className="dropdown-item">Proposer offre d'emploi</a></li>
...
{/* <p>Institut Supérieur des Etudes Technologiques de Jendouba</p>
<p>المعهد العالي للدراسات التكنولوجية بجندوبة</p> */}
      {/*Left links*/}
    </div>
    {/*Collapsible wrapper*/}
